    ...
    return (
      <dialogContext.Provider value={value}>
        <Dialog
          ...
          fullWidth
        >
          {title && <DialogTitle style={{fontFamily: 'monospace'}}>{title}</DialogTitle>}
          <DialogContent>{component}</DialogContent>
          <DialogActions>
            <Button style={{fontFamily: 'monospace'}} onClick={this.handleCloseClick} color="secondary">
              {cancelText}
            </Button>
            <Button style={{fontFamily: 'monospace'}} onClick={this.state.okCallback} color="primary">
              {okText}
            </Button>
          </DialogActions>
        </Dialog>
